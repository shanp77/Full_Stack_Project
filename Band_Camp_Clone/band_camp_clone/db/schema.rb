...
ActiveRecord::Schema.define(version: 2019_09_25_012047) do
  ...
  create_table "album_tags", force: :cascade do |t|
    ...
    t.index ["album_id", "tag_id"], name: "index_album_tags_on_album_id_and_tag_id", unique: true
  end
